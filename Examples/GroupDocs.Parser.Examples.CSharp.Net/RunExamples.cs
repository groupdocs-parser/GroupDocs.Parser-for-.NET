using System;
using GroupDocs.Parser.Examples.CSharp;
...
using GroupDocs.Parser.Examples.CSharp.AdvancedUsage.ExtractDataFromVariousFormats;
using AdvancedUsage = GroupDocs.Parser.Examples.CSharp.AdvancedUsage;
...
if (File.Exists(Constants.AsposeOcrLicensePath))
{
...
{
    Console.WriteLine("Advanced Usage OCR examples are working only with the license!");
    Console.WriteLine($"OCR license {Constants.AsposeOcrLicensePath} is missing!");
}
