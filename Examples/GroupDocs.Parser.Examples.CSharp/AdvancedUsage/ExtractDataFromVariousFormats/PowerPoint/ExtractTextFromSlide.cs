...
namespace GroupDocs.Parser.Examples.CSharp.AdvancedUsage.ExtractDataFromVariousFormats.PowerPoint
{
    ...
    static class ExtractTextFromSlide
    {
        ...
        {
            Console.WriteLine("\n--------------------------------------------------------------------------------------------------------------------");
            Console.WriteLine("[Example Advanced Usage] # ExtractTextFromSlide : This example shows how to extract a text from the slide of Microsoft Office PowerPoint presentation.\n");
