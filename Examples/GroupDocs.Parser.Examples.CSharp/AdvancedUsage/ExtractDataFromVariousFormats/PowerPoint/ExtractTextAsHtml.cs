...
namespace GroupDocs.Parser.Examples.CSharp.AdvancedUsage.ExtractDataFromVariousFormats.PowerPoint
{
    ...
    static class ExtractTextAsHtml
    {
        ...
        {
            Console.WriteLine("\n--------------------------------------------------------------------------------------------------------------------");
            Console.WriteLine("[Example Advanced Usage] # ExtractTextAsHtml : This example shows how to extract a text from Microsoft Office PowerPoint presentation as HTML.\n");
