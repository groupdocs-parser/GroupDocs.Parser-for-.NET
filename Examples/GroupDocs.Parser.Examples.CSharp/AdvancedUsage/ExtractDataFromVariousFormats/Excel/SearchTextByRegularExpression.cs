...
namespace GroupDocs.Parser.Examples.CSharp.AdvancedUsage.ExtractDataFromVariousFormats.Excel
{
    ...
    static class SearchTextByRegularExpression
    {
        ...
        {
            Console.WriteLine("\n--------------------------------------------------------------------------------------------------------------------");
            Console.WriteLine("[Example Advanced Usage] # SearchTextByRegularExpression : This example shows how to search with a regular expression in Microsoft Office Excel spreadsheet.\n");
