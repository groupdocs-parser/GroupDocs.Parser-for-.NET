...
namespace GroupDocs.Parser.Examples.CSharp.AdvancedUsage.ExtractDataFromVariousFormats.Excel
{
    ...
    static class ExtractTextFromSheet
    {
        ...
        {
            Console.WriteLine("\n--------------------------------------------------------------------------------------------------------------------");
            Console.WriteLine("[Example Advanced Usage] # ExtractTextFromSheet : This example shows how to extract a text from the page of Microsoft Office Excel spreadsheet.\n");
