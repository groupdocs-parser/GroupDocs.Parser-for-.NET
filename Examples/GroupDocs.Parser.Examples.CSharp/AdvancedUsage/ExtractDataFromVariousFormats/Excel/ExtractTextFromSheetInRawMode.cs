...
namespace GroupDocs.Parser.Examples.CSharp.AdvancedUsage.ExtractDataFromVariousFormats.Excel
{
    ...
    static class ExtractTextFromSheetInRawMode
    {
        ...
        {
            Console.WriteLine("\n--------------------------------------------------------------------------------------------------------------------");
            Console.WriteLine("[Example Advanced Usage] # ExtractTextFromSheetInRawMode : This example shows how to extract a raw text from the page of Microsoft Office Excel spreadsheet.\n");
