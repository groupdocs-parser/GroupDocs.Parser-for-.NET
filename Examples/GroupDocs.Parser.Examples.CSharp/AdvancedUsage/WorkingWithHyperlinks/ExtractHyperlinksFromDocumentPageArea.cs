...
namespace GroupDocs.Parser.Examples.CSharp.AdvancedUsage.WorkingWithHyperlinks
{
    ...
    static class ExtractHyperlinksFromDocumentPageArea
    {
        ...
        {
            Console.WriteLine("\n--------------------------------------------------------------------------------------------------------------------");
            Console.WriteLine("[Example Advanced Usage] # ExtractHyperlinksFromDocumentPageArea : This example shows how to extract hyperlinks from the document page area.\n");
