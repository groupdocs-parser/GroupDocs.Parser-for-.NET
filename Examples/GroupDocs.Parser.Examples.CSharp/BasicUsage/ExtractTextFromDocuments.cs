...
namespace GroupDocs.Parser.Examples.CSharp.BasicUsage
{
    ...
    /// </summary>
    static class ExtractTextFromDocuments
    {
        public static void Run()
        {
            Console.WriteLine("\n--------------------------------------------------------------------------------------------------------------------");
            Console.WriteLine("[Example Basic Usage] # ExtractTextFromDocuments : This example shows how to extract a text from a document.\n");
