...
using GroupDocsParserVisualStudioPlugin.GUI; 
using GroupDocsParserVisualStudioPlugin.Properties;

namespace GroupDocsParserVisualStudioPlugin
{
    public class Connect : Extensibility.IDTExtensibility2, IDTCommandTarget
    {
        ...
        private const string GROUPDOCS_MENU_TOOLTIP = "Download and Run GroupDocs.Parser for .NET API Examples";

        private const string VIEWER_COMMAND_NAME = "GroupDocsParserVSPlugin";
        private const string VIEWER_COMMAND_CAPTION = "New GroupDocs.Parser Example Project";
        private const string VIEWER_COMMAND_TOOLTIP = "Download and Run GroupDocs.Parser for .NET API Examples";
