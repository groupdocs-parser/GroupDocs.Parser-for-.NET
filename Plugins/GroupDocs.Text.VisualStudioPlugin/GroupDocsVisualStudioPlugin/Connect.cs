...
using GroupDocsTextVisualStudioPlugin.GUI;
using GroupDocsTextVisualStudioPlugin.Properties;

namespace GroupDocsTextVisualStudioPlugin
{
    public class Connect : Extensibility.IDTExtensibility2, IDTCommandTarget
    {
        ...
        private const string GROUPDOCS_MENU_TOOLTIP = "Download and Run GroupDocs.Text for .NET API Examples";

        private const string VIEWER_COMMAND_NAME = "GroupDocsTextVSPlugin";
        private const string VIEWER_COMMAND_CAPTION = "New GroupDocs.Text Example Project";
        private const string VIEWER_COMMAND_TOOLTIP = "Download and Run GroupDocs.Text for .NET API Examples";
